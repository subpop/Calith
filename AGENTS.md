...
- Open `Calith.xcodeproj` in Xcode 26+.
- Build: `Cmd+B` with the **Calith** scheme selected.
...
Calith should look and feel like a first-class macOS app, not a cross-platform
